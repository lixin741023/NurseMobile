<template>
    <div class="HuLiDanLuRu">
        ...
        <div class="HuanZhe_list">
            <ul>
                <li v-for="(a,b) in HuanZheList" @click="R_HuLiDanLuRu_detail(a)">
                    <div class="left">
    ...
    export default {
        ...
        methods:{
            ...
            get_HuanZheList_sync(){
                $.ajax({
                    type:'get',
                    url:this.url+'/threetest/queryPatByNurseUserIdMed',
                    async:false,
                    dataType:'json',
                    data:{
            ...
            R_HuLiDanLuRu_detail(obj){
                this.$router.push({
                    name:'HuLiDanLuRu_detail',
                    params:{
                        HuLiDanLuRu_detail:obj
                    }
                })
            }
        },
