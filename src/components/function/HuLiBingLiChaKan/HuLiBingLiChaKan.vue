<template>
    <div class="HuLiBingLiChaKan">
        ...
        <div class="HuanZhe_list">
            <ul>
                <li v-for="(a,b) in HuanZheList" @click="R_HuLiBingLiChaKan_detail(a)">
                    <div class="left">
    ...
    export default {
        ...
        methods:{
            ...
            get_HuanZheList_sync(){
                $.ajax({
                    type:'get',
                    url:this.url+'/enr/queryEnrByUserIdMed',
                    async:false,
                    dataType:'json',
                    data:{
            ...
            R_HuLiBingLiChaKan_detail(obj){
                this.$router.push({
                    name:'HuLiBingLiChaKan_detail',
                    params:{
                        HuLiBingLiChaKan_detail:obj
                    }
                })
            }
        },
